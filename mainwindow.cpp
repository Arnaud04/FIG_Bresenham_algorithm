...
void MainWindow::drawSegment2(MyMesh *_mesh,int x1, int y1, int x2, int y2, int reverseX, int reverseY)
{
    int x,y,dx,dy;
...
MainWindow::MainWindow(QWidget *parent) : QMainWindow(parent), ui(new Ui::MainWindow)
{
    ...
    ui->changeVersion->setStyleSheet("background-color: blue;");
}
...
void MainWindow::on_pushButton_generer_clicked()
{
    ...
    if(version1)
        ...
        drawSegment2(&mesh,vertex1_x, vertex1_y, vertex2_x, vertex2_y,1,1);

    qDebug()<< "version" << version1;
...
void MainWindow::on_changeVersion_clicked()
{
    qDebug()<<"test";
    if(version1)
    {
        if((vertex2_x - vertex1_x > 0 ) && (vertex2_y -vertex1_y > 0))
        {
            version1 = false;
            ui->changeVersion->setStyleSheet("background-color: orange;");
        }
    }
    else
    {
